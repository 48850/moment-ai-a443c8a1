...
const CHARACTERS: CharacterPreset[] = [
  { id: "forest-sage", name: "Hina", vibe: "Field-recordist, talks slow", accent: "#a8d5a2", shirt: "#3b5d3a",
  ...
  { id: "sky-pirate", name: "Cal", vibe: "Ex-pilot, dry humor", accent: "#f4a261", shirt: "#7b3f1c",
  ...
  { id: "junior-witch", name: "Mei", vibe: "Caffeinated rookie reporter", accent: "#ffd5e5", shirt: "#1d1230",
  ...
  { id: "bathhouse", name: "Yu", vibe: "Late-night radio host", accent: "#e8b04a", shirt: "#a02c3a",
  ...
  { id: "tea-granny", name: "Iro", vibe: "Local historian", accent: "#c9a84c", shirt: "#3a4a2b",
  ...
  { id: "wind-pilot", name: "Ren", vibe: "Skate-zine kid", accent: "#7ec8e3", shirt: "#1a3c5a",
  ...
  { id: "castle-wiz", name: "Ash", vibe: "Art school dropout", accent: "#d9a8ff", shirt: "#1f1432",
  ...
  { id: "tide-girl", name: "Nami", vibe: "Marine bio grad", accent: "#ff8a8a", shirt: "#c44a4a",
  ...
  { id: "boar-hunter", name: "Sho", vibe: "Park ranger, few words", accent: "#e8b04a", shirt: "#3a2818",
  ...
  { id: "soot-bard", name: "Kuro", vibe: "Beat-tape producer", accent: "#ffd166", shirt: "#0a0a0a",
